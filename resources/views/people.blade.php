<x-app-layout>
    ...
    <form class="max-w-md mx-auto bg-white p-12 rounded-lg" method="post" action="{{route('people.store')}}" enctype="multipart/form-data">
    @csrf
    <label class="relative w-20 h-20 cursor-pointer">
    <!-- Hidden file input -->
        <input type="file" id="photo" class="hidden"  name="photo_path" accept="image/*" required>
        <div id="preview" style="margin-top: 20px;" class="w-full h-full rounded-full">
            <img id="photoPreview" src="#" alt="Photo Preview" style="display:none" class="w-full h-full rounded-full">
        </div>
    <!-- Outer Circle -->
        <div class="w-full h-full rounded-full bg-gray-300 flex items-center justify-center" id="photo_placeholder">
            <!-- Inner Circle (Profile Icon) -->
        ...
        <!-- Camera Icon (Overlay) -->
        <div class="absolute bottom-0 right-0 transform translate-x-[-123%] translate-y-[-28%]">
            <div class="w-12 h-12 rounded-full flex items-center justify-center">
            <img src="{{asset('images/photo-camera-svgrepo-com.svg')}}" alt="" srcset="">
            </div>
        </div>
    </label>
    <div class="my-4">
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="text" name="details" id="floating_repeat_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            <label for="floating_repeat_password" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Complete Address</label>
        </div>
        <div class="grid md:grid-cols-2 md:gap-6">
            <div class="relative z-0 w-full mb-5 group">
                <input type="text"  name="longitude" id="floating_phone" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="text" name="latitude" id="floating_company" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="date" name="expiration_date" id="floating_repeat_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        document.getElementById('photo').addEventListener('change', function (event) {
            ...
            if (file) {
                ...
                reader.onload = function (e) {
                    ...
                    photoPreview.src = e.target.result; // Set the src of the img to the file data
